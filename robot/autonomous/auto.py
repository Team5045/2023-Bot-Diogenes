...
class Autonomous(AutonomousStateMachine):
    ...
    def Raise1(self):
        ...
        if ROT_AVG != 0:
            ...
            self.sd.putValue("MODE: ", "Initial Rotate")
        else:
            self.boom_controller.set_target(0)
            self.sd.putValue("MODE: ", "SUCCESS!")
            self.next_state("grab1")

    @state
    def grab1(self):
        self.grabber.solenoid_toggle()
        self.sd.putValue("MODE: ", "Grabbing")
